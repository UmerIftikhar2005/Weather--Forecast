...
- (void)FromURL:(NSString *)URL{
    ...
    NSURLSession *session = [NSURLSession sharedSession];
        ...
        [[session dataTaskWithURL:url completionHandler:^(NSData *weatherdata, NSURLResponse *response, NSError *error) {
            ...
            if (weatherdata) {
                NSString *FileToWriteWeatherDataTo = @"C:\Users\umeri\Desktop\PF-FINAL PROJECT\Weather forecast project\Weather forecast project\WeatherData.csv";
...
int main(){
        ...
        string Location;
            ...
            //Set the latitude and longitude based on the provided location
        ...
        void CurrentWeather( ){
            ...
            ifstream Readfile("C:\Users\umeri\Desktop\PF-FINAL PROJECT\Weather forecast project\Weather forecast project\WeatherData.csv");
            ...
            while(getline(EighthLine4, variable8, ',') && getline(EighthLine5, value8, ',')){
                if (variable8 == SearchValue8){
                    cout<<"Wind direction per 10m in your city: "<<value5<<" °"<<endl;
                }
            }
